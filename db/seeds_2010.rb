...
キーワード: selector namespace, classbox, context-oriented programming"
  ...
  e27.create :title => "Let's create your own T-shirt designed by Ruby at RubyKaigi 2010!! / The Origami Ruby (paper craft) Generated by The Ruby", :title_ja => "Rubykaigiで自分だけのrubyTシャツを作ろう！/ Ruby で作る Ruby の折り紙", :speaker => 'Yasuo Yoshikawa (tmix producer) / Hiroyuki Shimura (Nihon Ruby-no-kai (Japan Ruby Group))', :room => foyer, :from => '13:00', :to => '15:30', :abstract => "Let's create your own T-shirt designed by Ruby at RubyKaigi 2010!!!:
...
EventLoader.with_options(:day => 28) do |e28|
  ...
  e28.with_options(:room => medium) do |e28_medium|
    ...
    e28_medium.create :title => 'Keynote中継', :title_ja => '基調講演中継', :length => 1.hour
...
EventLoader.with_options(:day => 29) do |e29|
  ...
  e29.with_options(:room => medium) do |e29_medium|
    ...
    e29_medium.create_break
    e29_medium.create :title => 'Keynote中継', :title_ja => '基調講演中継', :length => 1.hour
  end
  ...
  e29.with_options(:room => a202) do |e29_a202|
    e29_a202.create :title => 'Ruby Game Developers Kaigi', :title_ja => 'Rubyゲーム会議', :speaker => 'kumaryu (Ryuichi Sakamoto)', :from => '10:00', :length => 2.hours
