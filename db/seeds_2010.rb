...
ABSTRACT_JA
  e27.create :title => "Let's create your own T-shirt designed by Ruby at RubyKaigi 2010!!", :title_ja => 'RubyKaigiで自分だけのrubyTシャツを作ろう！', :speaker => 'Yasuo Yoshikawa (tmix producer)', :room => foyer, :from => '13:00', :to => '15:30',:abstract => (<<ABSTRACT), :abstract_ja => (<<ABSTRACT_JA), :lang => 'ja', :parent_event => foyer_event
...
ABSTRACT_JA
    ...
    e28_big.create :title => 'Let\'s calculate easily civil days by using "Ruby"', :title_ja => 'Rubyで手軽に暦日を算出しよう！', :abstract => '',:abstract_ja => (<<ABSTRACT_JA) ,:speaker => 'Yoshihiko Hara, Japan OSS Promotion Forum Application Sub Committee Ruby Application Task Force, FUJITSU SOCIAL SCIENCE LABORATORY LIMITED', :parent_event => lt_event, :from => '17:00', :to => '18:00'
"Almanac for Ruby"ライブラリーについて紹介します。
"Almanac for Ruby"ライブラリーは、暦日（干支、28宿、その他もろもろ）を手軽に算出するための、"Ruby"製ライブラリーです。
ABSTRACT_JA
...
ABSTRACT_JA
    e28_a201.create :title => 'Vim', :speaker => 'Kana', :to => '17:00',:abstract => (<<ABSTRACT), :lang => 'ja'
...
ABSTRACT
  ...
  foyer_event = e28.create :title => "Let's create your own T-shirt designed by Ruby at RubyKaigi 2010!! / The Origami Ruby (paper craft) Generated by The Ruby", :title_ja => 'RubyKaigiで自分だけのrubyTシャツを作ろう！ / Ruby で作る Ruby の折り紙', :speaker => '(See Abstract)', :room => foyer, :from => '12:00', :to => '17:00',:abstract => (<<ABSTRACT), :abstract_ja => (<<ABSTRACT_JA), :lang => 'ja'
Events held during the session in the foyer.
ABSTRACT
会期中にホワイエにて行われているイベントです。
ABSTRACT_JA
  e28.create :title => "Let's create your own T-shirt designed by Ruby at RubyKaigi 2010!!", :title_ja => 'RubyKaigiで自分だけのrubyTシャツを作ろう！', :speaker => 'Yasuo Yoshikawa (tmix producer)', :room => foyer, :from => '12:00', :to => '17:00',:abstract => (<<ABSTRACT), :abstract_ja => (<<ABSTRACT_JA), :lang => 'ja', :parent_event => foyer_event
Let's create your own T-shirt designed by Ruby on tmix! tmix is the only on-demand retail platform for consumers.
...
2010 年 8 月 27 日(金)のみ開催注文は28 日(土)13時から17時までに会場で受け取りできる人のみ。
ABSTRACT_JA
  e28.create :title => "The Origami Ruby (paper craft) Generated by The Ruby", :title_ja => 'Ruby で作る Ruby の折り紙', :speaker => 'Hiroyuki Shimura (Nihon Ruby-no-kai (Japan Ruby Group))', :room => foyer, :from => '12:00', :to => '17:00',:abstract => (<<ABSTRACT), :abstract_ja => (<<ABSTRACT_JA), :lang => 'ja', :parent_event => foyer_event
  The Origami Ruby (paper craft) Generated by The Ruby: Let's fold origami \"Ruby\" like http://dl.dropbox.com/u/4921720/RubyFoldings/IMG_0362.A3_C35_Chu25.WebSmall.JPG  . In the first half, we will fold origami \"Ruby\" together with the origami paper that has crease fold lines. In the second half, we will fold something with foil paper and cellophane paper and read a Ruby script that generates paper with crease fold lines.
ABSTRACT
  Ruby の折り紙を折ります。http://dl.dropbox.com/u/4921720/RubyFoldings/IMG_0362.A3_C35_Chu25.WebSmall.JPG
  折り線をプリントした展開図を用意しますので、前半それを参考にみんなで折りましょう。後半は、ちょっと難しくなりますがホイル折紙や透明折紙(セロファン)で折ってみたり、或は展開図を作成する Rubyスクリプトを読みましょう。
