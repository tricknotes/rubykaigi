class EventLoader
  ...
  def self.create(values)
    ...
    event = Event.create :presenter_name => speaker, :presenter_profile_en => profile, :presenter_profile_ja => profile_ja || profile, :title_en => title, :title_ja => title_ja || title, :abstract_en => abstract, :abstract_ja => abstract_ja || abstract, :additional_info => 'あとでかく', :lang => lang, :break => is_break, :parent_event => parent_event, :presentation_material => presentation_material, :vimeo_id => vimeo_id, :nicovideo_id => nicovideo_id
